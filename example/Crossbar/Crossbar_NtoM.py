...
class Crossbar_NtoM(Component):
    ...
    def __init__(self,src_num,dst_num,dat_width):
        super().__init__()
#参数定义
...
# #实例化模块
        ...
        Mux_Nto1_lst = [self.set("inst_Mux_Nto1_%d"%i,Mux_Nto1.Mux_Nto1(self.src_num,self.dat_width)) for i in range(0,self.dst_num)]
# 接口连接
...
#实例化Top模块
inst_Crossbar_NtoM = Crossbar_NtoM(3,2,4)
#生成verilog
