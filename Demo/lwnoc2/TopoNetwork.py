...
class Network(object):
    ...
    def generate_verilog(self):
        design = DWrap(self)
        design.set_module_name_prefix(self.rtl_prefix)
        design.generate_verilog(iteration=True)
        design.generate_filelist(prefix='$PRJ_ICDIR/',name='%s_flist.f' % self.rtl_prefix)